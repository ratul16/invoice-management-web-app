      ...
      <div class="add-edit-form">
        ...
        <section>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-12">
              <label for="country" class="form-label"> Project Descriptions </label>
              <input type="text" class="form-control" id="country" v-model="formData.description" />
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="row g-3">
            ...
            <div class="col-md-12">
              <button class="btn draft btn-block" @click="addNewItem">
        ...
        <div class="form-footer">
          <button v-if="invoice && !invoice.id" class="btn danger" @click="close">Discard</button>
          <button class="btn draft" @click="close">Cancel</button>
          <button class="btn primary" @click="addEditInvoice">Save Changes</button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    if (this.isVisible && this.invoice.id) {
